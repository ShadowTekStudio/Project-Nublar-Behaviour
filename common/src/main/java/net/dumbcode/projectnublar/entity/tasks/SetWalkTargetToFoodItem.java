...
public class SetWalkTargetToFoodItem<E extends Dinosaur> extends ExtendedBehaviour<E> {
    ...
    private static final List<Pair<MemoryModuleType<?>, MemoryStatus>> MEMORY_REQUIREMENTS = ObjectArrayList.of(
            ...
            Pair.of(MemoryTypesInit.IS_THIRSTY.get(), MemoryStatus.VALUE_ABSENT));
    ...
    public SetWalkTargetToFoodItem<E> predicate(final BiPredicate<E, BlockPos> predicate) {
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, E entity) {
        this.target = BrainUtils.getMemory(entity, MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM).blockPosition();
