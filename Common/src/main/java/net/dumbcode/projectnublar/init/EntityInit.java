...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<Dinosaur>> TYRANNOSAURUS_REX = registerEntity("tyrannosaurus_rex", () -> EntityType.Builder.of(Dinosaur::new, MobCategory.MONSTER).sized(2, 3), Zombie::createAttributes);
